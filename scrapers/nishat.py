...
# Updated clothing collections for Nishat Linen
    ...
    for product in products:
        try:
            ...
            processed_product = {
                ...
                'url': f"https://nishatlinen.com/products/{product.get('handle')}",
                'price_min': min_price,
                'price_max': max_price,
                'available': available,
...
def save_data(processed_data, raw_products):
    ...
    # Save processed JSON
    json_file = f"data/nishat_clothing_{timestamp}.json"
    ...
    summary_file = f"data/nishat_clothing_{timestamp}_summary.txt"
    with open(summary_file, 'w', encoding='utf-8') as f:
        f.write("=" * 60 + "\n")
        f.write("NISHAT LINEN CLOTHING COLLECTION - SCRAPING SUMMARY\n")
        f.write("=" * 60 + "\n\n")
...
def main():
    print("\nStarting Nishat Linen clothing scrape (accessories excluded)...\n")
    print("=" * 60)
